...
class Promotions {
    ...
    Map<String, dynamic> toJson() => {
        "promotionalOffers": promotionalOffers != null ? List<dynamic>.from(promotionalOffers!.map((x) => x?.toJson())) : null,
        "upcomingPromotionalOffers": upcomingPromotionalOffers != null ? List<dynamic>.from(upcomingPromotionalOffers!.map((x) => x!.toJson())) : null,
    };
}
